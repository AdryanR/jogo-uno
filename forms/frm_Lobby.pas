...
begin
  ...
  begin
    ...
    lblCodigoPartida.Font.Name := 'Aganè';
...
begin
  ShowMessage('Este jogo é o TCS do 3º semestre de ADS' + #13 + 'na matéria de DpD realizado pelos alunos:' + #13 + 'Adryan Rafael da Silva' + #13 + 'Anderson Rafael Bruns' + #13 + 'Fábio Domingues' + #13 + 'Ricardo da Silva Amorin Filho.');
end;
